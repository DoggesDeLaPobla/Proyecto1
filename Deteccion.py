...
parser.add_argument('--modeldir', help='Folder the .tflite file is located in',
                    required=True)
parser.add_argument('--graph', help='Nombre del archivo .tflite',
                    default='detect.tflite')
parser.add_argument('--labels', help='Nombre del labelmap',
                    default='labelmap.txt')
parser.add_argument('--threshold', help='Sensibilidad de notificación',
                    default=0.5)
...
# Eliminamos la etiqueta ??? ya que provoca errores
if labels[0] == '???':
    del(labels[0])
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            if 'dog'==object_name or 'cat' == object_name:
                ...
                for i in copia:
                    if len(i.split(" "))>=6:
                        if i.split(" ")[5]=="Ambos" or categorias[object_name]==i.split(" ")[5]:
